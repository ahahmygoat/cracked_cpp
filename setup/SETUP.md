...
**Full cheat sheet:** see `setup/git-github-cheatsheet.md`.
...
- **Git**: See `setup/git-github-cheatsheet.md`. `.gitignore` keeps exe, a.out, build dirs, and IDE/OS junk out of the repo.
